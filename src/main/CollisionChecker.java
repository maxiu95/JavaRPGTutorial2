...
public class CollisionChecker {
    ...
    public int checkObject(Entity entity, boolean player) {
            ...
            if(gp.obj[i] != null) {
                ...
                switch(entity.direction) {
                    case "up":
                        ...
                        if (entity.solidArea.intersects(gp.obj[i].solidArea)) { // checks if both rectangles collide
        ...
        return index; // check if player is hitting an object and return index of sed object
    }
}
